...
public abstract class BaseHeadActivity extends BaseActivity{
    ...
    protected void setIvLeft(int res){
        iv_left = (ImageView)findViewById(R.id.left_iv);
        if(iv_left != null){
    ...
    protected void setTvLeft(String title){
        tv_left = (TextView)findViewById(R.id.title_tv);
        if(tv_left != null){
    ...
    protected void setIvTitle(int resId){
        iv_title = (ImageView)findViewById(R.id.title_iv);
        if (iv_title != null){
    ...
    protected void setIvRight1(int res){
        insertImage = (ImageView)findViewById(R.id.insertButton);
        if(insertImage != null){
    ...
    protected void setIvRight2(int res){
        theme = (ImageView)findViewById(R.id.themeButton);
        if(theme != null){
    ...
    protected void setIvRight4(int res){
        option = (ImageView)findViewById(R.id.optionButton);
        if(option != null){
